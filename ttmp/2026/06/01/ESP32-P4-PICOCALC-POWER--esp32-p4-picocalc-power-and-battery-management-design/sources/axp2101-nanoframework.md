---
Title: Source - axp2101-nanoframework
...
- Related nanoFramework binding: [`Iot.Device.Axp192`](https://docs.nanoframework.net/devicesdetails/Axp192/README.html)
...
The AXP2101 supports many additional features including VBUS input limits, backup battery charging, fast power-on sequencing, fuel gauge ROM programming, sleep/wakeup, and DCDC forced-PWM mode. You can check out the [sample](https://github.com/nanoFramework/nanoFramework.IoT.Device/tree/main/devices/Axp2101/samples) to get more details on how to use these features.
...
If migrating from the [`Axp192`](https://docs.nanoframework.net/devicesdetails/Axp192/README.html) binding, note these key differences:
