...
- Added research diary and initial task list
- Wrote an inventory/analysis of existing tmux + serial + `idf.py` helper scripts and derived Go tooling requirements
