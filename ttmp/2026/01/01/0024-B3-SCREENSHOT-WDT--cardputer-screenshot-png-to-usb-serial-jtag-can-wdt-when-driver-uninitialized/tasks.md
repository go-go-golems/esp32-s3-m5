...
- [ ] Fix `serial_write_all()` to avoid infinite retry / yield to IDLE (ticket 0024)
- [ ] Decide/init strategy for USB-Serial/JTAG driver (`usb_serial_jtag_driver_install` vs console Kconfig)
