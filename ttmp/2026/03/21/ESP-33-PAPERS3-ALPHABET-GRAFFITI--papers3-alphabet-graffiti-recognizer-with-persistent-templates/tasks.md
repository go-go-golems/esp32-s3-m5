...
- [x] Create ticket `ESP-33-PAPERS3-ALPHABET-GRAFFITI`
- [x] Create diary document
- [x] Create new `0077-papers3-alphabet-graffiti` project skeleton
- [x] Reuse donor PaperS3 components and Protractor math module
- [x] Create a simple placeholder two-mode UI that defines the product direction
