...
RelatedFiles:
    ...
    - Path: imports/esp32-mqjs-repl/mqjs-repl/main/CMakeLists.txt
      Note: Current build only compiles main.c; needs updating when splitting into C++ files
    - Path: imports/esp32-mqjs-repl/mqjs-repl/main/main.c
      Note: Current monolithic REPL+SPIFFS+JS implementation this design proposes to split
...
The current firmware entrypoint (`imports/esp32-mqjs-repl/mqjs-repl/main/main.c`) mixes several concerns in one file: storage (SPIFFS), library autoloading, UART transport, a line editor, JS engine initialization, and REPL evaluation. This makes it hard to:
...
- Current monolithic implementation: `imports/esp32-mqjs-repl/mqjs-repl/main/main.c`
