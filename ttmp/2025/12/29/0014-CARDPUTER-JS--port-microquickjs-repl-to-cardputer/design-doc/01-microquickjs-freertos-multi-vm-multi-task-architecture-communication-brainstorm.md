...
Our early example firmware (pre-split monolith; now deleted) was a blocking REPL:
...
- Current firmware entry: `imports/esp32-mqjs-repl/mqjs-repl/main/app_main.cpp`
