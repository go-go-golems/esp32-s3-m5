...
// ESP-IDF glue for Arduino-style timing helpers used by AnimatedGIF.cpp.
// We keep this behind ESP_PLATFORM so non-Arduino desktop builds remain unaffected.
#include "esp_timer.h"
#include "freertos/FreeRTOS.h"
#include "freertos/task.h"
static inline long millis(void) { return (long)(esp_timer_get_time() / 1000); }
static inline void delay(long ms) { vTaskDelay(pdMS_TO_TICKS(ms)); }
#endif // ESP_PLATFORM
#endif
