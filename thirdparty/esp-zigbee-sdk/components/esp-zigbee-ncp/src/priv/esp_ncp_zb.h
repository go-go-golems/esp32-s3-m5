...
#define ESP_NCP_NETWORK_NVRAM_ERASE_AT_START_SET 0x002E /*!< Enable/disable erasing zb_storage at next start */
#define ESP_NCP_NETWORK_NVRAM_ERASE_AT_START_GET 0x002F /*!< Get the nvram-erase-at-start flag */
