/*
 * 0049: esp_console REPL for configuring Wi-Fi STA at runtime.
 *
 * Pattern and UX based on:
 * - 0045-xiao-esp32c6-preact-web/main/wifi_console.c
...
static const char *TAG = "mlednode_wifi_console";
