...
static const char *TAG = "m5dial_bench_wifi";

#define CORES3_WIFI_AP_SSID "M5Dial-Bench"
#define CORES3_WIFI_AP_PASSWORD "m5dialbench"
#define CORES3_WIFI_AP_CHANNEL 1
#define CORES3_WIFI_AP_MAX_CONN 4
#define CORES3_WIFI_HOSTNAME "m5dial-bench"
