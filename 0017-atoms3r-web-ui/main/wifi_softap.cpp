/*
 * Tutorial 0017: WiFi SoftAP bring-up (ESP-IDF).
 */
...
esp_err_t wifi_softap_start(void) {
    ...
    // Avoid -Wstringop-overread false positives by measuring length from the destination buffer.
    ...
    // The DHCP server is started automatically for the default AP netif.
    log_ap_ip();
