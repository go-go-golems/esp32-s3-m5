...
static const uint64_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x000073696c6c696d,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3Version" (offset=554) */
  0x6f69737265563373,
  0x000000000000006e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "s3Reset" (offset=557) */
  0x0074657365523373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "s3Text" (offset=559) */
  0x0000747865543373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "s3Row" (offset=561) */
  0x000000776f523373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "s3Col" (offset=563) */
  0x0000006c6f433373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "s3Spacer" (offset=565) */
  0x7265636170533373,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3Divider" (offset=568) */
  0x6564697669443373,
  0x0000000000000072,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3Progress" (offset=571) */
  0x6572676f72503373,
  0x0000000000007373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "s3List" (offset=574) */
  0x00007473694c3373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "s3Region" (offset=576) */
  0x6e6f696765523373,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3AddChild" (offset=579) */
  0x6968436464413373,
  0x000000000000646c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3SetText" (offset=582) */
  0x7865547465533373,
  0x0000000000000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (13 << (JS_MTAG_BITS + 3)), /* "s3SetProgress" (offset=585) */
  0x6f72507465533373,
  0x0000007373657267,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "s3Config" (offset=588) */
  0x6769666e6f433373,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3Present" (offset=591) */
  0x6e65736572503373,
  0x0000000000000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "s3LibraryCount" (offset=594) */
  0x72617262694c3373,
  0x0000746e756f4379,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (13 << (JS_MTAG_BITS + 3)), /* "s3LibraryLine" (offset=597) */
  0x72617262694c3373,
  0x000000656e694c79,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "s3EmbeddedLine" (offset=600) */
  0x646465626d453373,
  0x0000656e694c6465,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3OpenBook" (offset=603) */
  0x6f426e65704f3373,
  0x0000000000006b6f,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookOpen" (offset=606) */
  0x704f6b6f6f423373,
  0x0000000000006e65,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "s3BookTitle" (offset=609) */
  0x69546b6f6f423373,
  0x0000000000656c74,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (15 << (JS_MTAG_BITS + 3)), /* "s3BookLineCount" (offset=612) */
  0x694c6b6f6f423373,
  0x00746e756f43656e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookLine" (offset=615) */
  0x694c6b6f6f423373,
  0x000000000000656e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookNext" (offset=618) */
  0x654e6b6f6f423373,
  0x0000000000007478,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookPrev" (offset=621) */
  0x72506b6f6f423373,
  0x0000000000007665,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "s3BookProgress" (offset=624) */
  0x72506b6f6f423373,
  0x000073736572676f,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (12 << (JS_MTAG_BITS + 3)), /* "s3TimerStart" (offset=627) */
  0x5372656d69543373,
  0x0000000074726174,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "s3TimerStop" (offset=630) */
  0x5372656d69543373,
  0x0000000000706f74,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3StoreGet" (offset=633) */
  0x4765726f74533373,
  0x0000000000007465,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3StoreSet" (offset=636) */
  0x5365726f74533373,
  0x0000000000007465,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (16 << (JS_MTAG_BITS + 3)), /* "s3AppendPostcard" (offset=639) */
  0x646e657070413373,
  0x6472616374736f50,
  0x0000000000000000,

  /* sorted atom table (offset=643) */
  ...
  JS_ROM_VALUE(579), /* s3AddChild */
  JS_ROM_VALUE(639), /* s3AppendPostcard */
  JS_ROM_VALUE(615), /* s3BookLine */
  JS_ROM_VALUE(612), /* s3BookLineCount */
  JS_ROM_VALUE(618), /* s3BookNext */
  JS_ROM_VALUE(606), /* s3BookOpen */
  JS_ROM_VALUE(621), /* s3BookPrev */
  JS_ROM_VALUE(624), /* s3BookProgress */
  JS_ROM_VALUE(609), /* s3BookTitle */
  JS_ROM_VALUE(563), /* s3Col */
  JS_ROM_VALUE(588), /* s3Config */
  JS_ROM_VALUE(568), /* s3Divider */
  JS_ROM_VALUE(600), /* s3EmbeddedLine */
  JS_ROM_VALUE(594), /* s3LibraryCount */
  JS_ROM_VALUE(597), /* s3LibraryLine */
  JS_ROM_VALUE(574), /* s3List */
  JS_ROM_VALUE(603), /* s3OpenBook */
  JS_ROM_VALUE(591), /* s3Present */
  JS_ROM_VALUE(571), /* s3Progress */
  JS_ROM_VALUE(576), /* s3Region */
  JS_ROM_VALUE(557), /* s3Reset */
  JS_ROM_VALUE(561), /* s3Row */
  JS_ROM_VALUE(585), /* s3SetProgress */
  JS_ROM_VALUE(582), /* s3SetText */
  JS_ROM_VALUE(565), /* s3Spacer */
  JS_ROM_VALUE(633), /* s3StoreGet */
  JS_ROM_VALUE(636), /* s3StoreSet */
  JS_ROM_VALUE(559), /* s3Text */
  JS_ROM_VALUE(627), /* s3TimerStart */
  JS_ROM_VALUE(630), /* s3TimerStop */
  JS_ROM_VALUE(554), /* s3Version */
  ...
  /* global object properties (offset=2051) */
