...
// deadline fires (Phase 4 proves the mechanism; widgets consume it later).
...
void InputHandleTick() {
    ...
    for (uint32_t i = 0; i < n; ++i) {
        ...
        // Every input postpones the quiet-window deadline (reschedule by
