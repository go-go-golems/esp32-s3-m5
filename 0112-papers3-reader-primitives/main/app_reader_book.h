// Embedded fixture book for the Phase 8 vertical slice: the opening of
// Alice's Adventures in Wonderland (public domain). SD-card books arrive
// with Phase 6; this constant proves the reading pipeline end to end.
#pragma once

namespace reader {

constexpr const char kEmbeddedBookTitle[] = "Alice in Wonderland";

constexpr const char kEmbeddedBookText[] =
