...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x6c6c696d,
  0x00007369,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3Version" (offset=781) */
  0x65563373,
  0x6f697372,
  0x0000006e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "s3Reset" (offset=785) */
  0x65523373,
  0x00746573,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "s3Text" (offset=788) */
  0x65543373,
  0x00007478,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "s3Row" (offset=791) */
  0x6f523373,
  0x00000077,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "s3Col" (offset=794) */
  0x6f433373,
  0x0000006c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "s3Spacer" (offset=797) */
  0x70533373,
  0x72656361,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3Divider" (offset=801) */
  0x69443373,
  0x65646976,
  0x00000072,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3Progress" (offset=805) */
  0x72503373,
  0x6572676f,
  0x00007373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "s3List" (offset=809) */
  0x694c3373,
  0x00007473,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "s3Region" (offset=812) */
  0x65523373,
  0x6e6f6967,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3AddChild" (offset=816) */
  0x64413373,
  0x69684364,
  0x0000646c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3SetText" (offset=820) */
  0x65533373,
  0x78655474,
  0x00000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (13 << (JS_MTAG_BITS + 3)), /* "s3SetProgress" (offset=824) */
  0x65533373,
  0x6f725074,
  0x73657267,
  0x00000073,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "s3Config" (offset=829) */
  0x6f433373,
  0x6769666e,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "s3Present" (offset=833) */
  0x72503373,
  0x6e657365,
  0x00000074,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "s3LibraryCount" (offset=837) */
  0x694c3373,
  0x72617262,
  0x756f4379,
  0x0000746e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (13 << (JS_MTAG_BITS + 3)), /* "s3LibraryLine" (offset=842) */
  0x694c3373,
  0x72617262,
  0x6e694c79,
  0x00000065,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "s3EmbeddedLine" (offset=847) */
  0x6d453373,
  0x64646562,
  0x694c6465,
  0x0000656e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3OpenBook" (offset=852) */
  0x704f3373,
  0x6f426e65,
  0x00006b6f,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookOpen" (offset=856) */
  0x6f423373,
  0x704f6b6f,
  0x00006e65,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "s3BookTitle" (offset=860) */
  0x6f423373,
  0x69546b6f,
  0x00656c74,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (15 << (JS_MTAG_BITS + 3)), /* "s3BookLineCount" (offset=864) */
  0x6f423373,
  0x694c6b6f,
  0x6f43656e,
  0x00746e75,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookLine" (offset=869) */
  0x6f423373,
  0x694c6b6f,
  0x0000656e,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookNext" (offset=873) */
  0x6f423373,
  0x654e6b6f,
  0x00007478,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3BookPrev" (offset=877) */
  0x6f423373,
  0x72506b6f,
  0x00007665,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "s3BookProgress" (offset=881) */
  0x6f423373,
  0x72506b6f,
  0x6572676f,
  0x00007373,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (12 << (JS_MTAG_BITS + 3)), /* "s3TimerStart" (offset=886) */
  0x69543373,
  0x5372656d,
  0x74726174,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "s3TimerStop" (offset=891) */
  0x69543373,
  0x5372656d,
  0x00706f74,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3StoreGet" (offset=895) */
  0x74533373,
  0x4765726f,
  0x00007465,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "s3StoreSet" (offset=899) */
  0x74533373,
  0x5365726f,
  0x00007465,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (16 << (JS_MTAG_BITS + 3)), /* "s3AppendPostcard" (offset=903) */
  0x70413373,
  0x646e6570,
  0x74736f50,
  0x64726163,
  ...
  JS_ROM_VALUE(816), /* s3AddChild */
  JS_ROM_VALUE(903), /* s3AppendPostcard */
  JS_ROM_VALUE(869), /* s3BookLine */
  JS_ROM_VALUE(864), /* s3BookLineCount */
  JS_ROM_VALUE(873), /* s3BookNext */
  JS_ROM_VALUE(856), /* s3BookOpen */
  JS_ROM_VALUE(877), /* s3BookPrev */
  JS_ROM_VALUE(881), /* s3BookProgress */
  JS_ROM_VALUE(860), /* s3BookTitle */
  JS_ROM_VALUE(794), /* s3Col */
  JS_ROM_VALUE(829), /* s3Config */
  JS_ROM_VALUE(801), /* s3Divider */
  JS_ROM_VALUE(847), /* s3EmbeddedLine */
  JS_ROM_VALUE(837), /* s3LibraryCount */
  JS_ROM_VALUE(842), /* s3LibraryLine */
  JS_ROM_VALUE(809), /* s3List */
  JS_ROM_VALUE(852), /* s3OpenBook */
  JS_ROM_VALUE(833), /* s3Present */
  JS_ROM_VALUE(805), /* s3Progress */
  JS_ROM_VALUE(812), /* s3Region */
  JS_ROM_VALUE(785), /* s3Reset */
  JS_ROM_VALUE(791), /* s3Row */
  JS_ROM_VALUE(824), /* s3SetProgress */
  JS_ROM_VALUE(820), /* s3SetText */
  JS_ROM_VALUE(797), /* s3Spacer */
  JS_ROM_VALUE(895), /* s3StoreGet */
  JS_ROM_VALUE(899), /* s3StoreSet */
  JS_ROM_VALUE(788), /* s3Text */
  JS_ROM_VALUE(886), /* s3TimerStart */
  JS_ROM_VALUE(891), /* s3TimerStop */
  JS_ROM_VALUE(781), /* s3Version */
  ...
  /* global object properties (offset=2359) */
...
static const JSCFunctionDef js_c_function_table[] = {
  ...
  { { .generic = js_s3_col },
    JS_ROM_VALUE(794) /* s3Col */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_spacer },
    JS_ROM_VALUE(797) /* s3Spacer */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_divider },
    JS_ROM_VALUE(801) /* s3Divider */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_progress },
    JS_ROM_VALUE(805) /* s3Progress */,
    JS_CFUNC_generic, 3, 0 },
  { { .generic = js_s3_list },
    JS_ROM_VALUE(809) /* s3List */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_region },
    JS_ROM_VALUE(812) /* s3Region */,
    JS_CFUNC_generic, 3, 0 },
  { { .generic = js_s3_add_child },
    JS_ROM_VALUE(816) /* s3AddChild */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_set_text },
    JS_ROM_VALUE(820) /* s3SetText */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_set_progress },
    JS_ROM_VALUE(824) /* s3SetProgress */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_config },
    JS_ROM_VALUE(829) /* s3Config */,
    JS_CFUNC_generic, 6, 0 },
  { { .generic = js_s3_present },
    JS_ROM_VALUE(833) /* s3Present */,
    JS_CFUNC_generic, 5, 0 },
  { { .generic = js_s3_library_count },
    JS_ROM_VALUE(837) /* s3LibraryCount */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_library_line },
    JS_ROM_VALUE(842) /* s3LibraryLine */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_s3_embedded_line },
    JS_ROM_VALUE(847) /* s3EmbeddedLine */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_open_book },
    JS_ROM_VALUE(852) /* s3OpenBook */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_s3_book_open },
    JS_ROM_VALUE(856) /* s3BookOpen */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_s3_book_title },
    JS_ROM_VALUE(860) /* s3BookTitle */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_book_line_count },
    JS_ROM_VALUE(864) /* s3BookLineCount */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_book_line },
    JS_ROM_VALUE(869) /* s3BookLine */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_s3_book_next },
    JS_ROM_VALUE(873) /* s3BookNext */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_book_prev },
    JS_ROM_VALUE(877) /* s3BookPrev */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_book_progress },
    JS_ROM_VALUE(881) /* s3BookProgress */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_timer_start },
    JS_ROM_VALUE(886) /* s3TimerStart */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_s3_timer_stop },
    JS_ROM_VALUE(891) /* s3TimerStop */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3_store_get },
    JS_ROM_VALUE(895) /* s3StoreGet */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_store_set },
    JS_ROM_VALUE(899) /* s3StoreSet */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_s3_append_postcard },
    JS_ROM_VALUE(903) /* s3AppendPostcard */,
    JS_CFUNC_generic, 1, 0 },
};
