...
> Encodes the specified string as a center justified 2D barcode. Only k bytes of the string will be read and any remaining will be treated as regular text or ESC/POS commands. The command and data must be enclosed by [Line Feeds](https://escpos.readthedocs.io/en/latest/cursor_position.html#x0a).
> 
> Note
> 
...
![pyramidqr](https://escpos.readthedocs.io/en/latest/_images/pyramidacceptors.com.jpg)
...
> 
> > <table><tbody><tr><td><p>cn</p></td><td><p>fn</p></td><td><p>Function no.</p></td><td><p>Function Name</p></td></tr><tr><td rowspan="2"><p>49</p></td><td><p>80</p></td><td><p>Function 180</p></td><td><p>QR Code: Store the data in the symbol storage area.</p></td></tr><tr><td><p>81</p></td><td><p>Function 181</p></td><td><p>QR Code: Print the symbol data in the symbol storage area.</p></td></tr></tbody></table>
> > 
> > <table><tbody><tr><td><p>cn</p></td><td><p>fn</p></td><td><p>Function no.</p></td><td><p>[parameters]</p></td></tr><tr><td rowspan="2"><p>49</p></td><td><p>80</p></td><td><p>Function 180</p></td><td><p>m = 48</p></td></tr><tr><td><p>81</p></td><td><p>Function 181</p></td><td><p>m = 48, d1…dk</p></td></tr></tbody></table>
> > 
> > - Function 180:
...
> Example:
> 
> Print URL as 2D barcode (sample binary [`bin`](https://escpos.readthedocs.io/en/latest/_downloads/bcf8ce1b87a9f07bf4f9684b605b13d6/phx_sample_qr.txt))
> 
> ```
> write("\x0d")                             # newline
...
> Related:
> 
> [Select Justification](https://escpos.readthedocs.io/en/latest/layout.html#b61)
> 
> Example:
> 
> ```
...
> - This command feeds as much paper as is required to print the entire raster bit image, regardless of line spacing defined by [1/6” or 1/8”](https://escpos.readthedocs.io/en/latest/layout.html#b32) commands.
...
> Example:
> 
> [Github](https://github.com/PyramidTechnologies/reliance-helpers)

---

## Print Graphic Bank/Logo - $1B $FA

> Prints logo `n` from internal storage using dimensions defined as [Two Byte Numbers](https://escpos.readthedocs.io/en/latest/intro.html#byte).
> 
> Format:
> 
