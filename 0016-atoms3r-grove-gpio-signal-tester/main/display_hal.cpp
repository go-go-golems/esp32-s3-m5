/*
 * Tutorial 0016: Display bring-up (AtomS3R GC9107) via M5GFX/LovyanGFX.
 */
...
bool display_init_m5gfx(void) {
    // Configure SPI bus
    {
        ...
        cfg.spi_mode = 0;
        cfg.spi_3wire = true;
        cfg.freq_write = CONFIG_TUTORIAL_0016_LCD_SPI_PCLK_HZ;
    ...
    // Configure panel
    {
        ...
        pcfg.panel_width = CONFIG_TUTORIAL_0016_LCD_HRES;
        pcfg.panel_height = CONFIG_TUTORIAL_0016_LCD_VRES;
        pcfg.offset_x = CONFIG_TUTORIAL_0016_LCD_X_OFFSET;
        pcfg.offset_y = CONFIG_TUTORIAL_0016_LCD_Y_OFFSET;
        pcfg.readable = false;
#if CONFIG_TUTORIAL_0016_LCD_INVERT
        pcfg.invert = true;
#else
        pcfg.invert = false;
#endif
#if CONFIG_TUTORIAL_0016_LCD_RGB_ORDER_RGB
    ...
    ESP_LOGI(TAG, "m5gfx init: pclk=%dHz gap=(%d,%d) invert=%d rgb_order=%s",
             CONFIG_TUTORIAL_0016_LCD_SPI_PCLK_HZ,
             CONFIG_TUTORIAL_0016_LCD_X_OFFSET,
             CONFIG_TUTORIAL_0016_LCD_Y_OFFSET,
             invert,
             rgb_order);
...
#if CONFIG_TUTORIAL_0016_PRESENT_USE_DMA
    s_display.waitDMA();
#endif
}
