...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x6c6c696d,
  0x00007369,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (16 << (JS_MTAG_BITS + 3)), /* "widgetDestroyAll" (offset=781) */
  0x67646977,
  0x65447465,
  0x6f727473,
  0x6c6c4179,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (15 << (JS_MTAG_BITS + 3)), /* "widgetLiveCount" (offset=787) */
  0x67646977,
  0x694c7465,
  0x6f436576,
  0x00746e75,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "S3Widget" (offset=792) */
  0x69573353,
  0x74656764,
  0x00000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "get value" (offset=796) */
  0x20746567,
  0x756c6176,
  0x00000065,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "bump" (offset=800) */
  0x706d7562,
  0x00000000,

  /* sorted atom table (offset=803) */
  ...
  JS_ROM_VALUE(781), /* widgetDestroyAll */
  JS_ROM_VALUE(787), /* widgetLiveCount */
  ...
  (4 << 1) | (JS_PROP_NORMAL << 30),
  JS_ROM_VALUE(183) /* constructor */,
  (uint32_t)(-JS_CLASS_S3WIDGET - 1) << 1,
  (0 << 1) | (JS_PROP_SPECIAL << 30),
  /* class (offset=2251) */
  JS_MB_HEADER_DEF(JS_MTAG_OBJECT),
  JS_ROM_VALUE(2227),
  ...
  /* global object properties (offset=2256) */
...
static const JSCFunctionDef js_c_function_table[] = {
  ...
  { { .generic = js_performance_now },
    JS_ROM_VALUE(567) /* now */,
    JS_CFUNC_generic, 0, 0 },
  { { .constructor = js_s3widget_constructor },
    JS_ROM_VALUE(792) /* S3Widget */,
    JS_CFUNC_constructor, 1, JS_CLASS_S3WIDGET },
  { { .generic = js_s3widget_get_value },
    JS_ROM_VALUE(796) /* get value */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_s3widget_bump },
    JS_ROM_VALUE(800) /* bump */,
    JS_CFUNC_generic, 0, 0 },
  ...
  { { .generic = js_millis },
    JS_ROM_VALUE(778) /* millis */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_widget_destroy_all },
    JS_ROM_VALUE(781) /* widgetDestroyAll */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_widget_live_count },
    JS_ROM_VALUE(787) /* widgetLiveCount */,
    JS_CFUNC_generic, 0, 0 },
};
...
static const JSCFinalizer js_c_finalizer_table[JS_CLASS_COUNT - JS_CLASS_USER] = {
  [JS_CLASS_S3WIDGET - JS_CLASS_USER] = js_s3widget_finalizer,
};
