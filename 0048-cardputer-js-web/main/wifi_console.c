/*
 * 0048: esp_console REPL for configuring Wi-Fi STA at runtime.
 *
 * Adapted from: 0046-xiao-esp32c6-led-patterns-webui/main/wifi_console.c
 *
 * Usage:
 *   wifi status
 *   wifi scan [max]
