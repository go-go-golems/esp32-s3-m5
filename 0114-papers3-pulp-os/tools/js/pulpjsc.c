...
STUB(js_auth_configure)
STUB(js_auth_start)
STUB(js_auth_state)
STUB(js_auth_state_name)
STUB(js_auth_user_code)
STUB(js_auth_verification_uri)
STUB(js_auth_verification_uri_complete)
STUB(js_auth_error)
STUB(js_auth_grant_seconds)
STUB(js_auth_token_seconds)
STUB(js_auth_poll_seconds)
STUB(js_auth_clear)
STUB(js_socket_open)
STUB(js_socket_bearer)
STUB(js_socket_start)
STUB(js_socket_stop)
STUB(js_socket_state)
STUB(js_socket_state_name)
STUB(js_socket_message_count)
STUB(js_socket_message_seq)
STUB(js_socket_message)
STUB(js_socket_received)
STUB(js_socket_dropped)
STUB(js_socket_error)
STUB(js_serve_get)
