...
static const uint32_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  /* sorted atom table (offset=1163) */
  JS_VALUE_ARRAY_HEADER(350),
  ...
  /* global object properties (offset=3185) */
