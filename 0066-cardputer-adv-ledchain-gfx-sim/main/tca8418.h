...
//
// Note: This is intentionally tiny and synchronous. It's extracted from the
// Cardputer-ADV keyboard demos in this repo and is sufficient for reading
// KEY_EVENT_A and basic init.
